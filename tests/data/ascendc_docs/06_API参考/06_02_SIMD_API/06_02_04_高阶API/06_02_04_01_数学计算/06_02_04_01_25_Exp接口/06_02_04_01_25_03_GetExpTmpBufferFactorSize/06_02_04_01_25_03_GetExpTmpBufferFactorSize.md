...
ge::Shape shape(shape_vec);uint32_t maxValue = 0;uint32_t minValue = 0;bool res = AscendC::GetExpMaxMinTmpSize(shape, 2, false, maxValue, minValue);

## 6.2.4.1.25.3 GetExpTmpBufferFactorSize
