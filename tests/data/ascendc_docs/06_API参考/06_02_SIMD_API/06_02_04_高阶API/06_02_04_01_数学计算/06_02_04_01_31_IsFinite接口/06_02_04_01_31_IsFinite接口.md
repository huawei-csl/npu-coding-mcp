...
完整的调用样例请参考6.2.4.1.49 更多样例。uint32_t maxLiveNodeCount = 0;uint32_t extraBuf = 0;AscendC::GetFmodTmpBufferFactorSize(typeSize, maxLiveNodeCount, extraBuf);

## 6.2.4.1.31 IsFinite 接口
