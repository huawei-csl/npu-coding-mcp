...
auto plat = platform_ascendc::PlatformAscendC(context->GetPlatformInfo());AscendC::GetBitwiseNotMaxMinTmpSize(plat, shape, 2, false, maxValue, minValue);

## 6.2.4.1.44.3 GetBitwiseNotTmpBufferFactorSize
