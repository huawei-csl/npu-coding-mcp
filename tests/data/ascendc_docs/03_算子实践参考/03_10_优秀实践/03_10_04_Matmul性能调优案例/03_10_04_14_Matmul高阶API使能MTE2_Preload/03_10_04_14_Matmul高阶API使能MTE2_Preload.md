...
优化方法总耗时(us)AIC_MTE2平均耗时(us)

**AIV_MTE2平均耗时(us)**

随路ND2NZ149.82130.770

Vector侧ND2NZ93.7622.8510.31
...
## 3.10.4.14 Matmul 高阶API 使能MTE2 Preload
...
![p0734_img001.png](../../images/p0734_img001.png)

●优化前的Profiling数据如下，aic_time平均耗时30.88us。

![p0734_img002.png](../../images/p0734_img002.png)

设计优化方案

使能MTE2 Preload功能：在创建Matmul对象时，开启doMTE2Preload开关。使能MTE2 Preload的完整样例请参考M方向预加载Matmul算子样例。具体步骤如下：

步骤1配置MDL模板参数，将其中的doMTE2Preload参数设置为2，使能N方向Preload功能。

```cpp
// preloadMode = 2static constexpr MatmulConfig MM_CFG = GetMDLConfig(false, false, preloadMode);
```

步骤2基于自定义MatmulConfig模板参数，创建Matmul对象。
...
![p0735_img001.png](../../images/p0735_img001.png)

●优化后的Profiling数据如下，aic_time平均耗时28.50us，较优化前的30.88us有所下降。

![p0735_img002.png](../../images/p0735_img002.png)
