...
// 输入shape信息为1024;算子输入的数据类型为half;不允许修改源操作数std::vector<int64_t> shape_vec = {1024};ge::Shape shape(shape_vec);uint32_t max;uint32_t min;AscendC::GetGeGLUMaxMinTmpSize(shape, 2, false, max, min);

## 6.2.4.3.7.3 GetGeGLUTmpBufferFactorSize
