...
auto plat = platform_ascendc::PlatformAscendC(context->GetPlatformInfo());AscendC::GetBitwiseOrMaxMinTmpSize(plat, shape, 2, false, maxValue, minValue);

## 6.2.4.1.46.3 GetBitwiseOrTmpBufferFactorSize
