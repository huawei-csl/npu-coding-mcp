...
optiling::TCubeTiling tilingData;   int ret = tiling.GetTiling(tilingData);int baseM = tiling.GetBaseM();  // 获取Tiling计算得到的baseM

## ?.22. GetBaseN

功能说明

获取Tiling计算得到的baseN值。baseN参数的说明请参考表6-1072。
