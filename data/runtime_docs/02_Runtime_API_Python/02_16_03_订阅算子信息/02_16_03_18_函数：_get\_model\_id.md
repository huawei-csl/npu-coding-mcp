...
uint64\_t aclprofGetOpDuration(const void *opInfo, size\_t opInfoLen, uint32\_t index)

- python 函数

op\_duration = acl.prof.get\_op\_duration(op\_info, op\_info\_len, index)
