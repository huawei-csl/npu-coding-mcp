...
aclError aclrtMemcpyBatchAsync(void **dsts, size\_t *destMaxs, void **srcs, size\_t *sizes, size\_t numBatches, aclrtMemcpyBatchAttr *attrs, size\_t *attrsIndexes, size\_t numAttrs, size\_t *failIndex, aclrtStream stream)
