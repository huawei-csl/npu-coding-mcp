...
根据物理设备 ID 获取对应的逻辑设备 ID 。

aclError aclrtGetLogicDevIdByPhyDevId(const int32\_t phyDevId, int32\_t *const logicDevId)
...
![Figure](../../images/figure_0939.png)

**[Image: figure_0939.png (1586x822, 134.0KB)]**
