...
根据逻辑设备 ID 获取对应的用户设备 ID 。

aclError aclrtGetUserDevIdByLogicDevId(const int32\_t logicDevId, int32\_t *const userDevid)

| 参数名        | 输入 / 输 出   | 说明        |
|------------|------------|-----------|
| logicDevId | 输入         | 逻辑设备 ID 。 |
| userDevid  | 输出         | 用户设备 ID 。 |
...
![Figure](../../images/figure_0923.png)

**[Image: figure_0923.png (1586x824, 134.1KB)]**
