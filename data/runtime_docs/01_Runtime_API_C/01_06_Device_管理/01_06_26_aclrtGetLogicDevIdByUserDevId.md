...
根据用户设备 ID 获取对应的逻辑设备 ID 。

aclError aclrtGetLogicDevIdByUserDevId(const int32\_t userDevid, int32\_t *const logicDevId)

| 参数名        | 输入 / 输 出   | 说明        |
|------------|------------|-----------|
| userDevid  | 输入         | 用户设备 ID 。 |
| logicDevId | 输出         | 逻辑设备 ID 。 |
...
![Figure](../../images/figure_0907.png)

**[Image: figure_0907.png (1585x819, 133.8KB)]**
